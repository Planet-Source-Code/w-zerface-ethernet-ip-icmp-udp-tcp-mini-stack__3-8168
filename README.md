...
A raw ethernet frame (I use a driver I wrote for SurfOs passing packets from a 3COM 3c905b-tx network card.

Assumes you have low level access to ethernet frames. (Try WinPCap for windows)

A reply ethernet frame to the given packet.

Very secure, and stable. Remembers no state information.
...
**Archive File**   |[](https://github.com/Planet-Source-Code/w-zerface-ethernet-ip-icmp-udp-tcp-mini-stack__3-8168/archive/master.zip)
